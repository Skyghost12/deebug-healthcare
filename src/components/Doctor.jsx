    ...
    return (
        ...
        className="relative bg-white rounded-lg shadow-md p-6 m-4">
            ...
            <div className="flex justify-between items-center mt-4 gap-4">
                <h3 className="font-bold text-lg text-left">{doctor.name}</h3>
            ...
            <div className="flex justify-between items-center mt-4 gap-4">
                <p className="text-gray-600 text-left">{doctor.specialization}</p>
                <p className="text-gray-600 text-left">Experience: {doctor.experience}</p>
            </div>
