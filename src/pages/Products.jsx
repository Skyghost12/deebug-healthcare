...
function Product() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 mt-8 overflow-hidden">
      ...
      <section className="bg-white flex justify-between items-center flex-col gap-4">
        <div className="mx-auto max-w-7xl px-2 py-16 sm:px-6 lg:px-2 ">
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            ...
            {pageNumbers.map((number) => (
              <button
                ...
                className={`px-2 py-2 rounded-lg ${currentPage === number
